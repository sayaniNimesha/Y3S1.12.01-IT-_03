...
public class BuyerService {
	...
	public String insertBuyer(@FormParam("bName") String bName,
			...
			@FormParam("bAddress") String bAddress, @FormParam("bEmail") String bEmail,
			@FormParam("bDate") String bDate, @FormParam("pNo") String pNo) {
		String output = "";
		if (bName.length() == 0 || bAddress.length() == 0 || bEmail.length() == 0 || bDate.length() == 0
				|| pNo.length() == 0) {
